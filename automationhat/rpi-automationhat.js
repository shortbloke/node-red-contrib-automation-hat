...
module.exports = function(RED) {
    ...
    var HAT = (function(){
        ...
        var cmd = __dirname+"/automationhatlink";
        var hat = null;
        var allowExit = false;
    ...
    RED.nodes.registerType("rpi-automationhat in",AutomationHATIn);
    ...
    RED.nodes.registerType("rpi-automationhat out",AutomationHATOut);
}
